...
struct DropzoneTabView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            HStack {
                Spacer()
                Text(String(localized: "dropzone.tab.header.title", defaultValue: "FROG DROP", bundle: .main, comment: "Title text shown at top of dropzone tab"))
            ...
            ZStack {
                ...
                HStack(spacing: 6) {
                    ...
                    Text(isTargeted ? String(localized: "dropzone.tab.drop-target.title", defaultValue: "Drop files here", bundle: .main, comment: "Instruction shown while dragging files over dropzone") : String(localized: "dropzone.tab.drop-target.subtitle", defaultValue: "Drag files here to store", bundle: .main, comment: "Instruction shown when not dragging files over dropzone"))
