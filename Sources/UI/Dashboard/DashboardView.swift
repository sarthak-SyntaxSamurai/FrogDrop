        ...
        VStack(spacing: 24) {
            ...
            HStack {
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    .fontWeight(.bold)
                    Text("Keep your focus game sharp today.")
            ...
            HStack(spacing: 24) {
                ...
                VStack(spacing: 16) {
                    ...
                    // Daily Goal
                    Text("Daily Goal: \(todayFocusMinutes)m / \(dailyFocusGoal)m")
                        .font(.system(.subheadline, design: .rounded))
                        .fontWeight(.bold)
                ...
                VStack(spacing: 16) {
                    // Quick Stats Grid
                    HStack(spacing: 12) {
                        StatCard(title: "Focused Today", value: "\(todayFocusMinutes)m", icon: "flame.fill", color: .orange)
                        StatCard(title: "Completed Tasks", value: "\(todoManager.items.filter { $0.isCompleted }.count)", icon: "checklist", color: .green)
                    }
