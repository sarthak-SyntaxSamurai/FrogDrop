...
struct ClipboardToastView: View {
    ...
    var body: some View {
        HStack(spacing: 6) {
            ...
            Text(String(
                localized: "clipboard-toast.item-type.temporary",
                defaultValue: "Temporary Item",
                bundle: .main,
                comment: "Label shown for temporary clipboard items"
            ))
            ...
            Button(action: {
                ...
                Text(String(
                    localized: "clipboard-toast.action.stay",
                    defaultValue: "Stay",
                    bundle: .main,
                    comment: "Button title to keep a temporary clipboard item"
                ))
